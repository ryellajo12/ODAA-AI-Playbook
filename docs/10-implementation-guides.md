...
| 3 | Paste system prompt from [Path 2 -- Agent System Prompt](04-foundry-agents.md#104-agent-system-prompt-template) into System message | 5 min |
...
| Step | Action | Time |
|--|--|--|
| 1 | Add VECTOR column to existing table (see [Pattern 2 -- Step 1](04-foundry-agents.md#step-1--add-vector-columns-to-existing-tables)) | 10 min |
| 2 | Configure Azure OpenAI credential in Oracle (DBMS_CLOUD) (see [Pattern 2 -- Step 2](04-foundry-agents.md#step-2--configure-embedding-generation)) | 10 min |
| 3 | Create embedding generation function ([Pattern 2 -- Step 2](04-foundry-agents.md#step-2--configure-embedding-generation)) | 15 min |
| 4 | Backfill embeddings for existing data (batch process) | 15 min |
| 5 | Create vector index ([Pattern 2 -- Step 2](04-foundry-agents.md#step-2--configure-embedding-generation)) | 5 min |
| 6 | Test vector search via SQL | 5 min |
| 7 | Create ORDS endpoint ([Pattern 2 -- Step 4](04-foundry-agents.md#step-4--expose-vector-search-via-ords-already-running-on-oracle-26ai)) | 15 min |
