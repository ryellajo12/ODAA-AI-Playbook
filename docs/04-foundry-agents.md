...
graph LR
    ...
    subgraph L5["Layer 5 Â· Audit & Threat"]
...
|-------------|-------|-----------|-------|------|----------------|
| **Access Control** | CC6.1 | A.9 | Â§164.312(a) | Art. 25 | Entra ID + PIM + Conditional Access |
| **Encryption** | CC6.7 | A.10 | Â§164.312(a)(2)(iv) | Art. 32 | TLS 1.2+ / TDE / SSE |
| **Audit Logging** | CC7.2 | A.12.4 | Â§164.312(b) | Art. 30 | Oracle Audit + Azure Monitor + Purview |
